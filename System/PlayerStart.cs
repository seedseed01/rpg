...
public class PlayerStart
{
    ...
    private static int getJob()
    {
        ...
        while (true)
        {
            ...
            {
                case 1:
                    jobInfo = "村莊中的樵夫，因長年揮舞斧頭，爆發力不可小覷，也是村莊中力量最大的，肌肉與長年累積的厚繭也增加自身不少保護力，但腳程較慢，對魔法一竅不通";
                    jobName = "樵夫";
                    break;
                case 2:
                    jobInfo = "村莊中的農夫，日出而作，日落而息，因長期下田耕地，擁有扎實的下盤功夫，跟樵夫比相撲從沒輸過，像是牆一樣屹立不倒，但腳程較慢，對魔法一竅不通";
                    jobName = "農夫";
                    break;
                case 3:
